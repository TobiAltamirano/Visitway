...
<section>
    ...
    <h1 class="h1-provincias text-4xl text-2xl title-font mb-4 text-gray-900 rojo-secundario poppins-semibold">Cargar alojamiento</h1>
    ...
    <section class="w-full py-12 md:py-24 lg:py-32 roboto-flex">
        <div class="container mx-auto max-w-4xl px-4 md:px-6">
            <div class="space-y-6">
                ...
                <form action="{{ route('administrador.alojamientos.crear.proceso') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="nombre_alojamiento" name="nombre_alojamiento" class="roboto-flex azul-principal flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('nombre_alojamiento') }}" @error('nombre_alojamiento') aria-describedby="error-nombre_alojamiento" aria-invalid="true" @enderror>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input type="number" id="precio_alojamiento" name="precio_alojamiento" class="roboto-flex azul-principal flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('precio_alojamiento') }}" @error('precio_alojamiento') aria-describedby="error-precio_alojamiento" aria-invalid="true" @enderror>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input id="horarios_alojamiento" name="horarios_alojamiento" class="roboto-flex azul-principal relative m-0 block w-full min-w-0 flex-auto rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('horarios_alojamiento') }}" @error('horarios_alojamiento') aria-describedby="error-horarios_alojamiento" aria-invalid="true" @enderror></input>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input id="ubicacion_alojamiento" name="ubicacion_alojamiento" class="roboto-flex azul-principal relative m-0 block w-full min-w-0 flex-auto rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('ubicacion_alojamiento') }}" @error('ubicacion_alojamiento') aria-describedby="error-ubicacion_alojamiento" aria-invalid="true" @enderror></input>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input id="contacto_alojamiento" name="contacto_alojamiento" class="roboto-flex azul-principal relative m-0 block w-full min-w-0 flex-auto rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('contacto_alojamiento') }}" @error('contacto_alojamiento') aria-describedby="error-contacto_alojamiento" aria-invalid="true" @enderror></input>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input type="text" id="url_sitio_web_alojamiento" name="url_sitio_web_alojamiento" class="roboto-flex azul-principal flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('url_sitio_web_alojamiento') }}" @error('url_sitio_web_alojamiento') aria-describedby="error-url_sitio_web_alojamiento" aria-invalid="true" @enderror>
                    ...
                    <div class="space-y-2">
                        ...
                        <select id="tipo_alojamiento_id" name="tipo_alojamiento_id" class="roboto-flex azul-principal flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" @error('tipo_alojamiento_id') aria-describedby="error-tipo_alojamiento_id" aria-invalid="true" @enderror>
                            ...
                            <option value="{{ $tipoAlojamiento->id_tipo_alojamiento }}" {{ old('tipo_alojamiento_id') == $tipoAlojamiento->id_tipo_alojamiento ? 'selected' : '' }}>
