...
<section>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <h2 class="text-lg font-medium">Control de Actividades</h2>
                ...
                <table class="w-full caption-bottom text-sm">
                    <thead class="[&amp;_tr]:border-b">
                        <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                            ...
                            <th class="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Provincia</th>
                    ...
                    <tbody class="[&amp;_tr:last-child]:border-0">
                        ...
                        <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                            <td class="p-4 align-middle">{{ $actividad->id_actividad }}</td>
                            <td class="p-4 align-middle">{{ $actividad->nombre_actividad }}</td>
                            <td class="p-4 align-middle">{{ $actividad->precio_actividad }}</td>
                            <td class="p-4 align-middle">{{ $actividad->provincia->nombre_provincia }}</td>
