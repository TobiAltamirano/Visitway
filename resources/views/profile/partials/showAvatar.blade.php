                ...
                <div class="flex">
                    <div class="flex items-center">
                        ...
                        <label for="avatar1" class="cursor-pointer avatar-label">
                            <img src="{{ asset('storage/avatars/avatar1.jpg') }}" alt="Avatar 1" class="w-20 h-20 rounded-full mr-2 avatar-option">
                        </label>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="avatar2" class="cursor-pointer avatar-label">
                            <img src="{{ asset('storage/avatars/avatar2.png') }}" alt="Avatar 2" class="w-20 h-20 rounded-full mr-2 avatar-option">
                        </label>
                    </div>
