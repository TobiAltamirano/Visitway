            ...
            <div class="encabezado-footer">
                ...
                <div>
                    <div class="redes-footer">
                        <div>
                            <a href="#">
                                <svg class="transform hover:scale-110 transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" height="32" width="28" viewBox="0 0 448 512">
                        ...
                        <div>
                            <a href="#">
                                <svg class="transform hover:scale-110 transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" height="32" width="24" viewBox="0 0 512 512">
                        ...
                        <div class="facebook-svg">
                            <a href="#">
                                <svg class="transform hover:scale-110 transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" height="24" width="20" viewBox="0 0 320 512">
