<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4">
  <h2 class="text-lg font-semibold mb-4 azul-principal poppins-semibold">Viernes</h2>
  <ul class="space-y-4">
    @if (empty($actividadesViernes))
    ...
    <li class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-2">
        ...
        <!-- Duplicate Button -->
        <button class="azul-principal inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 w-10 hover:text-accent-foreground hover:bg-gray-100 dark:hover:bg-gray-800" data-twe-toggle="modal" data-twe-target="#duplicateModal{{ $actividadViernes->id }}" data-twe-ripple-init data-twe-ripple-color="light">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5">
        ...
        <!-- Delete Button -->
        <button class="azul-principal inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 w-10 hover:text-accent-foreground hover:bg-gray-100 dark:hover:bg-gray-800" data-twe-toggle="modal" data-twe-target="#deleteModal{{ $actividadViernes->id }}" data-twe-ripple-init data-twe-ripple-color="light">
    ...
    <!-- Modal editar -->
    <div data-twe-modal-init class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none" id="editModal{{ $actividadViernes->id }}" data-twe-backdrop="static" data-twe-keyboard="false" tabindex="-1" aria-labelledby="editModalLabel{{ $actividadViernes->id }}" aria-hidden="true">
      <div data-twe-modal-dialog-ref class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
        <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-4 outline-none dark:bg-surface-dark">
          <div class="flex items-center justify-between rounded-t-md border-b-2 border-neutral-100 p-4 dark:border-white/10">
            <p class="azul-principal roboto-flex text-xl font-medium leading-normal text-surface dark:text-white" id="editModalLabel{{ $actividadViernes->id }}">
              Editar actividad
            </p>
          ...
          <div class="p-4" data-twe-modal-body-ref>
            <form action="{{ route('cronograma.editar', ['id' => $actividadViernes->id]) }}" method="post">
              ...
              <div class="mb-4">
                ...
                <input type="time" name="nueva_hora_inicio" id="nueva_hora_inicio" required class="roboto-flex azul-principal w-full px-3 py-2 rounded border-gray-300 focus:border-primary-500 focus:ring-primary-500">
              </div>
              <div class="mb-4">
              ...
              <button type="submit" class="roboto-flex boton-aplicar-cambios poppins-semibold w-full text-white py-2 px-4 rounded-lg transition duration-300">
                Guardar cambios
              </button>
            </form>
          </div>
    ...
    <!-- Modal duplicar  -->
    <div data-twe-modal-init class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none" id="duplicateModal{{ $actividadViernes->id }}" data-twe-backdrop="static" data-twe-keyboard="false" tabindex="-1" aria-labelledby="duplicateModalLabel{{ $actividadViernes->id }}" aria-hidden="true">
      <div data-twe-modal-dialog-ref class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
        <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-4 outline-none dark:bg-surface-dark">
          <div class="flex flex-shrink-0 items-center justify-between rounded-t-md border-b-2 border-neutral-100 p-4 dark:border-white/10">
            <p class="roboto-flex azul-principal text-xl font-medium leading-normal text-surface dark:text-white" id="duplicateModalLabel{{ $actividadViernes->id }}">
              Duplicar actividad
            </p>
            <button type="button" class="box-content rounded-none border-none text-neutral-500 hover:text-neutral-800 hover:no-underline focus:text-neutral-800 focus:opacity-100 focus:shadow-none focus:outline-none dark:text-neutral-400 dark:hover:text-neutral-300 dark:focus:text-neutral-300" data-twe-modal-dismiss aria-label="Close">
              <span class="azul-principal [&>svg]:h-6 [&>svg]:w-6">
          ...
          <div class="p-4" data-twe-modal-body-ref>
            <form action="{{ route('cronograma.duplicar', ['id' => $actividadViernes->id, 'idActividad' => $actividadViernes->id_actividad]) }}" method="post">
              @csrf
              <div class="mb-4">
    ...
    <!-- Modal eliminar -->
    <div data-twe-modal-init class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none" id="deleteModal{{ $actividadViernes->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $actividadViernes->id }}" aria-hidden="true">
      <div data-twe-modal-dialog-ref class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
        <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-4 outline-none dark:bg-surface-dark">
          <div class="flex flex-shrink-0 items-center justify-between rounded-t-md border-b-2 border-neutral-100 p-4 dark:border-white/10">
            <p class="roboto-flex azul-principal text-xl font-medium leading-normal text-surface dark:text-white" id="deleteModalLabel{{ $actividadViernes->id }}">
              Quitar actividad
            </p>
            <button type="button" class="box-content rounded-none border-none text-neutral-500 hover:text-neutral-800 hover:no-underline focus:text-neutral-800 focus:opacity-100 focus:shadow-none focus:outline-none dark:text-neutral-400 dark:hover:text-neutral-300 dark:focus:text-neutral-300" data-twe-modal-dismiss aria-label="Close">
              <span class="azul-principal [&>svg]:h-6 [&>svg]:w-6">
          ...
          <div class="flex flex-col justify-center items-center p-4" data-twe-modal-body-ref>
            <form action="{{ route('cronograma.eliminar', ['id' => $actividadViernes->id]) }}" method="post">
              ...
              <button type="submit" class="roboto-flex boton-eliminar poppins-semibold w-full text-white py-2 px-4 rounded-lg transition duration-300">
                Quitar actividad
              </button>
            </form>
          </div>
