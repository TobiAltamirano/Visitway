...
@section('content')
<section>
    <h1 class="h1-provincias text-4xl text-2xl title-font mb-4 text-gray-900 rojo-secundario poppins-semibold">Local gastronómico<br> <span class="span-h1-provincias">{{ $provincia->nombre_provincia }}</span></h1>
