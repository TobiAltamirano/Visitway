...
<section>
    ...
    <h1 class="h1-provincias text-4xl text-2xl title-font mb-4 text-gray-900 rojo-secundario poppins-semibold">Cargar actividad</h1>

    @include('components.lineas-secundarias')

    <section class="w-full justify-center py-12 md:py-24 lg:py-32 roboto-flex">
        <div class="container mx-auto max-w-4xl px-4 md:px-6">
            <div class="space-y-6">
                ...
                <form action="{{ route('administrador.actividades.crear.proceso') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="nombre_actividad" name="nombre_actividad" class="roboto-flex azul-principal flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('nombre_actividad') }}" @error('nombre_actividad') aria-describedby="error-nombre_actividad" aria-invalid="true" @enderror>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input type="number" id="precio_actividad" name="precio_actividad" class="roboto-flex azul-principal flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('precio_actividad') }}" @error('precio_actividad') aria-describedby="error-precio_actividad" aria-invalid="true" @enderror>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input id="horarios_actividad" name="horarios_actividad" class="roboto-flex azul-principal relative m-0 block w-full min-w-0 flex-auto rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('horarios_actividad') }}" @error('horarios_actividad') aria-describedby="error-horarios_actividad" aria-invalid="true" @enderror></input>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input id="ubicacion_actividad" name="ubicacion_actividad" class="roboto-flex azul-principal relative m-0 block w-full min-w-0 flex-auto rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('ubicacion_actividad') }}" @error('ubicacion_actividad') aria-describedby="error-ubicacion_actividad" aria-invalid="true" @enderror></input>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input id="contacto_actividad" name="contacto_actividad" class="roboto-flex azul-principal relative m-0 block w-full min-w-0 flex-auto rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" @error('contacto_actividad') value="{{ old('contacto_actividad') }}" aria-describedby="error-contacto_actividad" aria-invalid="true" @enderror></input>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input type="text" id="url_sitio_web_actividad" name="url_sitio_web_actividad" class="roboto-flex azul-principal flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('url_sitio_web_actividad') }}" @error('url_sitio_web_actividad') aria-describedby="error-url_sitio_web_actividad" aria-invalid="true" @enderror>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input type="number" id="duracion_actividad" name="duracion_actividad" class="roboto-flex azul-principal flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('duracion_actividad') }}" @error('duracion_actividad') aria-describedby="error-duracion_actividad" aria-invalid="true" @enderror>
                    ...
                    <div class="space-y-2">
                        ...
                        <select id="tipo_actividad_id" name="tipo_actividad_id" class="roboto-flex azul-principal flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" @error('tipo_actividad_id') aria-describedby="error-tipo_actividad_id" aria-invalid="true" @enderror>
                            ...
                            <option value="{{ $tipo->id_tipo_actividad }}" {{ old('tipo_actividad_id') == $tipo->id_tipo_actividad ? 'selected' : '' }}>
