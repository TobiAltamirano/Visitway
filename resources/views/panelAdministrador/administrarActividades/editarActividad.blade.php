            ...
            <div class="space-y-6">
                ...
                <form action="{{ route('administrador.actividades.crear.proceso') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <img src="{{ asset('storage/' . $actividad->imagen_actividad) }}" alt="Imagen Noticia - {{$actividad->titulo }}" class="mb-4">
                        @else
...
<section>
    ...
    <form action="{{ route('administrador.actividades.editar.proceso', $actividad->id_actividad) }}" class="form-panel" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3" class="div-input-label">
            ...
            <input type="text" id="nombre_actividad" name="nombre_actividad" class="form-control" maxlength="50" value="{{ old('nombre_actividad', $actividad->nombre_actividad) }}" @error('nombre_actividad') aria-describedby="error-nombre_actividad" aria-invalid="true" @enderror>
            @error('nombre_actividad')
