...
@section('title', 'Panel Administrador - Cargar Local Gastronómico')

@section('content')

<section>

    <h1 class="h1-provincias text-4xl text-2xl title-font mb-4 text-gray-900 rojo-secundario poppins-semibold">Panel admnistrador<span class="span-h1-provincias"><br>Cargar local gastronómico</span></h1>
            ...
            <div class="space-y-6">
                ...
                <form action="{{ route('administrador.locales_gastronomicos.crear.proceso') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" id="nombre_local_gastronomico" name="nombre_local_gastronomico" class="roboto-flex azul-principal flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('nombre_local_gastronomico') }}" @error('nombre_local_gastronomico') aria-describedby="error-nombre_local_gastronomico" aria-invalid="true" @enderror>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input id="horarios_local_gastronomico" name="horarios_local_gastronomico" class="roboto-flex azul-principal relative m-0 block w-full min-w-0 flex-auto rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('horarios_local_gastronomico') }}" @error('horarios_local_gastronomico') aria-describedby="error-horarios_local_gastronomico" aria-invalid="true" @enderror></input>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input id="ubicacion_local_gastronomico" name="ubicacion_local_gastronomico" class="roboto-flex azul-principal relative m-0 block w-full min-w-0 flex-auto rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('ubicacion_local_gastronomico') }}" @error('ubicacion_local_gastronomico') aria-describedby="error-ubicacion_local_gastronomico" aria-invalid="true" @enderror></input>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input id="contacto_local_gastronomico" name="contacto_local_gastronomico" class="roboto-flex azul-principal relative m-0 block w-full min-w-0 flex-auto rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" @error('contacto_local_gastronomico') value="{{ old('contacto_local_gastronomico') }}" aria-describedby="error-contacto_local_gastronomico" aria-invalid="true" @enderror></input>
                    ...
                    <div class="mb-3 form-check azul-principal roboto-flex">
                        ...
                        <label class="form-check-label" for="tiene_wifi">Es accesible</label>
                    </div>
                    ...
                    <div class="mb-3 form-check azul-principal roboto-flex">
                        ...
                        <label class="form-check-label" for="tiene_estacionamiento">Es gratis</label>
                    </div>
