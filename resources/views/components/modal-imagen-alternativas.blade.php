...
<div id="imageModal" class="fixed inset-0 flex items-center justify-center z-50 hidden">
    ...
    <div class="relative z-10 bg-white rounded-lg overflow-hidden shadow-lg max-w-full max-h-full">
        ...
        <img id="modalImage" src="" alt="Modal Image" class="w-auto h-auto max-w-full max-h-screen">
    </div>
</div>
