...
@section('title', 'Panel Administrador - Actividades')

@section('content')

<section>

    <h1 class="h1-provincias text-4xl text-2xl title-font mb-4 text-gray-900 rojo-secundario poppins-semibold">Panel administrador<span class="span-h1-provincias"><br>Actividades</span></h1>
    ...
    <div class="flex items-center flex-col justify-center gap-8 mt-12 mb-6">
        <h2 class="text-2xl font-bold azul-principal roboto-flex flex justify-center">Listado de actividades</h2>
        <button class="filtros-boton inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2">
            <a href="{{ route('administrador.actividades.crear') }}">Cargar actividad</a>
        </button>
    </div>
        ...
        <div class="relative w-full overflow-auto">
            <table class="w-full caption-bottom text-sm">
                ...
                <tbody class="[&amp;_tr:last-child]:border-0">
                    ...
                    <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                        <td class="p-4 align-middle roboto-flex azul-principal">{{ $actividad->id_actividad }}</td>
                        <td class="p-4 align-middle roboto-flex azul-principal">{{ $actividad->nombre_actividad }}</td>
                        <td class="p-4 align-middle roboto-flex azul-principal">{{ $actividad->precio_actividad }}</td>
                        <td class="p-4 align-middle roboto-flex azul-principal">{{ $actividad->provincia->nombre_provincia }}</td>
