            ...
            <div class="space-y-6">
                ...
                <form action="{{ route('administrador.locales_gastronomicos.crear.proceso') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500 azul-principal">Obligatorio</p>
                        <input id="contacto_local_gastronomico" name="contacto_local_gastronomico" class="roboto-flex azul-principal relative m-0 block w-full min-w-0 flex-auto rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" value="{{ old('contacto_local_gastronomico') }}" @error('contacto_local_gastronomico') aria-describedby="error-contacto_local_gastronomico" aria-invalid="true" @enderror></input>
