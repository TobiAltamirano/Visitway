...
<div class="relative submenu-button" data-twe-dropdown-ref>
    ...
    <ul class="absolute z-[1000] float-left m-0 hidden min-w-max list-none overflow-hidden rounded-lg border-none bg-white bg-clip-padding text-base shadow-lg data-[twe-dropdown-show]:block dark:bg-surface-dark" aria-labelledby="dropdownMenuButton2" data-twe-dropdown-menu-ref>
        ...
        <li>
            <a class="block w-full poppins-regular azul-principal whitespace-nowrap bg-white px-4 py-2 text-sm font-normal text-neutral-700 hover:bg-zinc-200/60 focus:bg-zinc-200/60 focus:outline-none active:bg-zinc-200/60 active:no-underline dark:bg-surface-dark dark:text-white dark:hover:bg-neutral-800/25 dark:focus:bg-neutral-800/25 dark:active:bg-neutral-800/25" href="{{ route('provincia.tipos-gastronomia', ['id' => $provincia->id_provincia]) }}" data-twe-dropdown-item-ref>Gastronomia</a>
        </li>
        <li>
